// src/lib.rs
/*
 * Core library for ImageEvolution
 */
...
#[derive(Debug)]
pub struct ImageEvolutionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ImageEvolutionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ImageEvolution processing");
    
    let mut processor = ImageEvolutionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ImageEvolutionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ImageEvolutionProcessor::new(false);
